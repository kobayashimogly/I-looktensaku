...
col1, col2 = st.columns([1, 20])  # 列を作成して画像を左に配置
with col1:
    st.image('https://s3.ap-northeast-1.amazonaws.com/rea.media.assets/9e6ac7fe-4f04-430a-8856-46785b9d658f.png', width=100)  # 画像URLを設定
...
# 業界のテキスト入力
industry = st.text_input("業界を入力してください", "", placeholder="広告業界・人材業界")
